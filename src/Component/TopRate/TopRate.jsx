...
export default function TopRate() {
  ...
  async function nowplaying(){
    let {data} = await axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=44ee5523e457e74020effc2bddc4592e&language=en-US&page=1')
 ...
 console.log(playingNow);
  ...
  {playingNow.length > 0 ?<div className="container">
    ...
    <div className="col-md-4">
        <h2 className='h4'>Top Rated Movies</h2>
